...
export default function ReturnPolicy() {
    let crumbs = [{name: "Home", trigger: "/", active: true}, {name: "Return Ploicy", trigger: "/returnPolicy",  active: false}]
    let refundConditionLists = ["We are committed to maintaining a long-lasting relationship with our customers by providing them with 100% satisfaction. If you are unsatisfied with your purchase for any reason, we will gladly accept the return of the product. We offer a generous 7-day, no-questions-asked return policy.",
      ...
      <BreadCrumbs crumbs={crumbs}/>
        <Container component="main" maxWidth="xl">
         <Box display="flex" flexDirection={'column'} mt={5} mb={5} sx={{}}>
            <Typography color={'appmain.main'}  variant="h6" component="div" sx={{fontWeight: 'normal', marginTop: 2, padding: 4, borderWidth: 1, borderColor: 'primary.light', backgroundColor: 'error.light'}}>
            Quality products that are priced at an honest value and backed by the best customer service possible. Our customers will remain our focus in the future. We will take care of each customer, one at a time, each time we hear from him or her. After all, everything is about… Emotions and Expressions...
            <br/>
            <br/>
