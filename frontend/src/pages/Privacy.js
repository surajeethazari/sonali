...
const collectionItems = ["Your name", "Your mailing address", "Your e-mail address", "Your phone number", "Demographic and lifestyle information, such as age, personal interests, and product preferences", "Location information"];
const infoItems = ["Fulfilling orders and requests for products, services or information", "Processing returns, exchanges and layaway requests", "Tracking and confirming online orders", "Delivering products", "Managing our Reward Zone program", "Marketing and advertising products and services", "Conducting research and analysis", "Establishing and managing your accounts with us", "Communicating things like special events, sweepstakes, promotions and surveys", "Identifying you on our websites and tailoring advertisements and offers to you based on your interactions online.", "Facilitating interactions with EthnicPlus and others, such as enabling you to e-mail a link to a friend", "Operating, evaluating and improving our business"];
const thirdPartItems = ["Fulfilling orders", "Delivering packages", "Sending EthnicPlus marketing communications", "Fulfilling subscription services", "Conducting research and analysis", "Providing chat functions"];

export default function Privacy() {
    let crumbs = [{name: "Home", trigger: "/", active: true}, {name: "Privacy", trigger: "/privacy",  active: false}]
  return (
    <Container maxWidth="xl">
       ...
       <Container component="main" maxWidth="xl">
            <Box display="flex" flexDirection={'column'} m={2} sx={{}}>
                ...
                <Typography color={'primary.main'}  variant="h6" component="div" sx={{fontWeight: 'normal', marginTop: 5}}>
                It may also include information you give us about other people, such as the name and address of a gift recipient, or the name and contact info of a friend & Family.
                ...
                <Typography color={'primary.dark'}  variant="h6" component="div" sx={{fontWeight: 'bold', marginTop: 3}}>
                ...
                <Typography color={'primary.main'}  variant="h6" component="div" sx={{fontWeight: 'normal', marginTop: 2}}>
                EthnicPlus does not sell, rent or trade your personal information to third parties.
                </Typography>
                <Typography color={'primary.main'}  variant="h6" component="div" sx={{fontWeight: 'normal', marginTop: 3}}>
                ...
                <Typography color={'primary.main'}  variant="h6" component="div" sx={{fontWeight: 'normal', marginTop: 3}}>
                Sometimes we may be required to share personal information in response to a regulation, court order or subpoena. We may also share information when we believe it's necessary to comply with the law. We may also share information to respond to a government request or when we believe disclosure is necessary or appropriate to protect the rights, property or safety of EthnicPlus, our customers, or others; to prevent harm or loss; or in connection with an investigation of suspected or actual unlawful activity.
                </Typography>
                <Typography color={'primary.main'}  variant="h6" component="div" sx={{fontWeight: 'normal', marginTop: 3}}>
                ...
                <Typography color={'primary.main'}  variant="h6" component="div" sx={{fontWeight: 'normal', marginTop: 2}}>
                Whether you are shopping online or in our stores, we use reasonable security measures to protect the confidentiality of personal information under our control and appropriately limit access to it. EthnicPlus cannot ensure or warrant the security of any information you transmit to us and you do so at your own risk.
                </Typography>
                <Typography color={'primary.dark'}  variant="h6" component="div" sx={{fontWeight: 'bold', marginTop: 3}}>
                HAVE QUESTIONS?
                </Typography>
                <Typography color={'primary.main'}  variant="h6" component="div" sx={{fontWeight: 'normal', marginTop: 2}}>
                If you have any questions about our Privacy Policy, we'll do our best to answer them. Please contact us at surajeet407@gmail.com.
                </Typography>
            </Box>
        </Container>
    </Container>
