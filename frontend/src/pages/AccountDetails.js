...
import { Box, CardMedia, Container, Divider, IconButton, Pagination, PaginationItem, Paper, Stack, Typography } from '@mui/material';
    ...
    <Container maxWidth="xl">
        ...
        <Box width={'100%'} justifyContent={'space-between'} display="flex" sx={{marginTop: 5, flexDirection: { xs: 'column', md: 'row'}}}>
            <Box display="flex" flexDirection={'column'}  sx={{width: {xs: '100%', md: '68%', marginBottom: "100px"}}}>
                ...
                <Typography color={'primary.main'}  variant="h6" component="div" sx={{fontWeight: 'bold', marginTop: 1}}>
                    {Constants.noOrderFoundText}
                </Typography>
                {data.map((item, index) => (
                <Paper elevation={2} key={index} sx={{height: item.height, marginTop: 2, height: '50px', padding: 5}}> 
                    <Box display="flex" flexDirection={'row'} justifyContent={'space-between'} >
                        ...
                        <Box display="flex" flexDirection={'column'}>
                            ...
                            <Typography component={'div'} variant="body2" color={'secondary.main'} sx={{fontWeight: 'bold', marginTop: "5px"}}>
                            TotalPrice: 5678 /-
                            </Typography>
                        </Box>
                    </Box>
            ...
            <Box display="flex" flexDirection={'column'}  sx={{width: {xs: '100%', md: '28%', marginBottom: "100px"}}}>
                ...
                <Box display="flex" flexDirection={'row'} sx={{marginTop: 1}}>
                    <IconButton size="medium" aria-label="search" color="inherit" sx={{ "&:hover": { color: "secondary.main" } }}>
                        <AccountCircle />
                    </IconButton>
                    <Typography color={'primary.main'}  variant="body2" component="div" sx={{fontWeight: '400', marginLeft: 1, marginTop: "10px"}}>
                        Name
                    </Typography>
                </Box>
